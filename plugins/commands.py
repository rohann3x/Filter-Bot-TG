...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        buttons = [
            [
                InlineKeyboardButton('🎭 updates Channel 🎭', url='https://t.me/josprojects')
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('💎 Updates Movies 💎', url='https://t.me/OfficialLMHD')
            ],[
            InlineKeyboardButton('Close', callback_data='close_data')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
    ...
    if data.split("-", 1)[0] == "BATCH":
        ...
        for msg in msgs:
            ...
            buttons = [
                [
                    InlineKeyboardButton('🎭 support Channel 🎭', url='https://t.me/LMovies_HD'),
                    InlineKeyboardButton(' 💎 updates Movie 💎', url='https://t.me/OfficialLMHD')
                ],
                [
                    InlineKeyboardButton('⚠️ Join Backup ⚠️', url=f'https://t.me/LMovies_HD')
                ]
                ]
            try:
